...
''' <summary>
''' The smallest possible host for the WinForms HTML editor. Open MainForm.vb in the
''' Visual Studio designer to see the layout: the editor is docked to fill the form, with a
''' status strip below it. This file holds only what happens at runtime - the document-level
''' stylesheet, the starting content, and a live character count of the current HTML.
''' </summary>
Partial Public Class MainForm
    ...
    Public Sub New()
        ...
        _editor.HeaderStyleContentElementID = DocumentStyleElementId
