...
#Region "Preset of possible values"
        ...
        ''' </summary>
        Private ReadOnly _listStylePosition As List(Of KeyValuePair(Of String, String)) = New List(Of KeyValuePair(Of String, String))()
#End Region
...
#End Region
        ...
        Private Sub ucLists_Load(sender As Object, e As EventArgs) Handles MyBase.Load
